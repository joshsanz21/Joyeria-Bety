...
<img src="../img/XX.gif"></div>
        ...
        <?php
            ...
            <td class='active'>$stock</td>
            <td class='active'>$precioactual</td>
            <td class='active'>$categoria</td>
            <td class='active'>$proveedor</td>
                             
            
           
                      
    <td class='active align='center'><center><a href='modificar.php?claveproducto=$claveproducto'><i class='fa fa-address-book fa-4'></i></a></center></td><td class='active' align='center'><a onClick='confirmar($claveproducto)'><i class='fa fa-times fa-4'></i></a></td>
  ...
  <script language="javascript"> 
    function confirmar(claveproducto){ 
    confirmar=confirm("\u00bfRealmente deseas eliminar el registro?"); 
    if (confirmar) 
    {
    document.location="eliminar_producto.php?opcion="+claveproducto;
    }
    else  
    {
        location.reload();
