...
<img src="../img/O.gif"></div>
                ...
                <!-- Begin Page Content -->
                      ...
                      <!-- Inicia la tabla -->
                      <table width="100%">
                      <form action="alta_empleados.php"method="post" id="frmalta_empleados">
                      
                      <tr class="espacio"> 
                      <td align="right"> <label for="curp">CURP-</label></td><td><input type="text" class="form-control" name="curp" id="curp" placeholder="Ingrese La Curp" autofocus required></td>
                      </tr>
                          
                      <tr class="espacio"> 
                      <td align="right"> <label for="fecha_nac">FECHA DE NACIMIENTO-</label></td><td><input type="date" class="form-control" name="fecha_nac" id="fecha_nac" placeholder="Ingrese Fecha De Nacimiento" required></td>
                      </tr>
                                             
                       <tr class="espacio"> 
                      <td align="right"> <label for="direccion">DIRECCION-</label></td><td><input type="text" class="form-control" name="direccion" id="direccion" placeholder="Ingrese La Direccion" required></td>
                       </tr>
                      ...
                      <td align="right"> <label for="nombre">NOMBRE-</label></td><td><input type="text" class="form-control" name="nombre" id="nombre" placeholder="Ingrese En Nombre" pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{1,15}" title="Solo puedes escribir letras de un rango de 10 caracteres" required></td>
                        ...
                        <tr class="espacio"> 
                      <td align="right"> <label for="apellidos">APELLIDOS-</label></td><td><input type="text" class="form-control" name="apellidos" id="apellidos" placeholder="Ingrese sus apellidos" pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{1,15}" title="Solo puedes escribir letras de un rango de 10 caracteres" required>
                      </td>
                      
                       <tr class="espacio"> 
                      <td align="right"> <label for="email">EMAIL-</label></td><td><input type="email" class="form-control" name="email" id="email" placeholder="Ingrese Correo Electronico" required>
                      </td>
                      ...
                      <td>
                      <tr class="espacio"> 
                      <td align="right"> <label for="telefono">TELEFONO-</label></td><td><input type="text" class="form-control" name="telefono" id="telefono" placeholder="Ingrese Numero De Telefono" pattern="[0-9]{10}".title="solo.puedes.teclear.numero.de.rango.de.10.digitos" required></td>
                      <td>
                      
                      <tr>
                      <td align="center" colspan="5"><input type="submit"  class="btn btn-outline-dark" value="REGISTRAR CLIENTE"  title="REGISTRAR EMPLEADOS"></td>
                      </tr>
