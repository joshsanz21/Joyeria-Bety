        ...
        <?php
               ...
               $result = mysqli_query($link, "SELECT * FROM cliente");
                ...
                echo "<tr>
                  ...
                  <th class='success'>APELLIDO(P)</th>
                 <th class='success'>APELLIDO(M)</th>
                 <th class='success'>TELEFONO</th>
                 <th class='success'>EMAIL</th>
                 <th class='success'>CIUDAD</th>
                 <th class='success'>COLONIA</th>
                <th class='success'>CALLE</th>  
...
$direccion = $row['direccion'];
            ...
            <td class='active'>$apellidopaterno</td>
            <td class='active'>$apellidomaterno</td>
            <td class='active'>$telefono</td>
            <td class='active'>$email</td>
            <td class='active'>$ciudad</td>
            <td class='active'>$colonia</td>
    ...
    <td class='active align='center'><center><a href='modificar.php?id_clientes=$id_clientes'><i class='fa fa-address-book fa-4'></i></a></center></td><td class='active' align='center'><a onClick='confirmar($id_clientes)'><i class='fa fa-times fa-4'></i></a></td>
  ...
  <script language="javascript"> 
    function confirmar(id_clientes){ 
    confirmar=confirm("\u00bfRealmente deseas eliminar el registro?"); 
    if (confirmar) 
    {
    document.location="eliminar_cliente.php?opcion="+id_clientes;
    }
    else  
    {
        location.reload();
