           ...
           <li class="nav-item">
                ...
                <div id="collapseproveedor" class="collapse" aria-labelledby="headingproveedor" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="proveedor.php">Consultar</a>
                        <a class="collapse-item" onClick='abrirReporte()'>Reportes</a>
            ...
            <!-- Main Content -->
                ...
                <!-- Begin Page Content -->
                 ...
                 <div class="col-md-6 offset-md-3">
                      ...
                      <td>
                      <tr class="espacio">
                      <td align="right"> <label for="direccion">DIRECCION-</label></td><td><input type="text" class="form-control" name="direccion" id="direccion" placeholder="Ingrese Direccion" required></td>
