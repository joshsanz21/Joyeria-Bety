...
$id_proveedor = $row['id_proveedor'];
        $nombre = $row['nombre'];
         ...
         $direccion = $row['direccion'];
            ...
            <td class='active align='center'><center><a href='modificar.php?id_proveedor=$id_proveedor'><i class='fa fa-address-book fa-4'></i></a></center></td>
            <td class='active' align='center'><a onClick='confirmar($id_proveedor)'><i class='fa fa-times fa-4'></i></a></td>
 ...
 <script language="javascript">
    ...
    if (confirmar)
    {
    document.location="eliminar_proveedor.php?opcion="+id_proveedor;
    }
    else
    {
        location.reload();
